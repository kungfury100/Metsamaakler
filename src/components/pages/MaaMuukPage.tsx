...
export const MaaMuukPage: React.FC = () => {
  ...
  const faqData = [
    {
      question: "Kui kaua võtab maa müük aega?",
      answer: "Müügi kiirus sõltub hinnast ja nõudlusest piirkonnas. Õiglase turuhinnaga kinnistu leiab ostja tavaliselt 2-4 nädala jooksul. Notaritehinguni jõudmine võtab lisaks umbes 1-2 nädalat dokumentide ettevalmistamiseks."
    },
    {
      question: "Milliseid dokumente on müügiks vaja?",
      answer: "Eelkõige on vaja isikut tõendavat dokumenti. Kui kinnistu on soetatud abielu ajal, on vaja abikaasa nõusolekut. Kinnistusraamatu väljavõtte ja muud tehnilised andmed hangib tavaliselt notar või maakler."
    },
    {
      question: "Kas ma pean maksma tulumaksu?",
      answer: "Jah, kinnisvara müügist saadav kasu on üldjuhul maksustatav tulumaksuga (20%). Erandiks on omandireformi käigus tagastatud maa esmane võõrandamine, mis on maksuvaba."
    },
    {
      question: "Kas ma saan müüa kinnistut koos hüpoteegiga?",
      answer: "Jah, saab küll. Sellisel juhul makstakse müügisummast esmalt kinni pangalaen ja hüpoteek kustutatakse tehingu käigus. Ülejäänud summa kantakse müüja kontole."
    }
  ];
  ...
  const schema = {
    ...
    '@graph': [
      {
        '@type': 'Service',
        'name': 'Maa ja kinnistu müük',
        'description': 'Professionaalne abi maa müügil. Hindamine, ostja leidmine ja tehingu vormistamine. Müü oma maa parima hinnaga.',
        'provider': {
          '@type': 'Organization',
          'name': 'Metsamaakler',
      ...
      },
      {
        ...
        'itemListElement': [
          ...
          },
          {
            ...
            'position': 3,
            'name': 'Maa müük',
            'item': 'https://metsamaakler.ee/maa-muuk/'
          }
        ]
      },
      {
  ...
  useSeo({
    title: "Maa müük – Kuidas müüa maad parima hinnaga? | Metsamaakler",
    description: "Planeerid maa müüki? Loe, kuidas kujuneb maa hind, millised on vajalikud dokumendid ja kuidas leida usaldusväärne ostja. Tasuta konsultatsioon.",
    canonical: "https://metsamaakler.ee/maa-muuk/",
    ogImage: HERO_IMAGE,
    schema: schema
  });
    ...
    <div className="min-h-screen relative bg-white font-inter selection:bg-[#347D4E] selection:text-white">
      ...
      <main className="relative z-10">
        <ServiceHero 
          image={HERO_IMAGE}
          title="Maa müük"
          subtitle="Maa müük on suur otsus, mis nõuab läbimõeldud tegutsemist. Aitame Sul läbida kogu protsessi alates hinna määramisest kuni eduka tehinguni notaris."
          onCtaClick={handleCtaClick}
          breadcrumbs={[
            { label: "Avaleht", href: "/" },
            { label: "Teenused", href: "/" },
            { label: "Maa müük", href: "/maa-muuk/" }
          ]}
        />
            ...
            <div className="lg:col-span-8">
              <article className="prose prose-lg max-w-none text-[#1a0f00]/70">
                ...
                <h2 className="text-[32px] md:text-[40px] font-bold text-[#1a0f00] mb-8 leading-[1.1] tracking-tight">
                  Kuidas müüa maad edukalt?
                </h2>
                
                <p className="mb-6 text-lg md:text-xl leading-snug font-normal text-[#1a0f00]/80">
                  Olenemata sellest, kas tegemist on metsamaa, põllumaa või elamumaaga, on müügiprotsessi põhitõed sarnased. Edukas tehing algab õigest ettevalmistusest ja realistlikust hinnaootusest.
                </p>

                <p className="mb-10 leading-[1.5]">
                  Maa müük võib tunduda keeruline bürokraatia, kuid õige partneriga on see lihtne ja turvaline protsess. Meie eesmärk on leida Sinu maale parim ostja ja tagada juriidiliselt korrektne tehing.
                </p>
                  ...
                  <div className="relative z-10 flex items-start gap-6">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="text-xl font-bold text-[#1a0f00] m-0 tracking-tight">Professionaalne abi</h3>
                      ...
                      <p className="text-[#1a0f00]/70 m-0 leading-normal text-base">
                        Kasutades Metsamaakleri abi, säästad aega ja närve. Meil on olemas investorite ja ostjate võrgustik, kes on valmis tegema pakkumisi koheselt. Lisaks korraldame kogu suhtluse notariga.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <p className="mb-6 leading-[1.5]">
                  Oleme jaotanud müügiprotsessi neljaks selgeks etapiks, et teaksid täpselt, mis ees ootab.
                </p>
                ...
                <div className="space-y-6 not-prose mb-12">
                  {[
                    { 
                      icon: Coins,
                      title: "1. Hinna määramine", 
                      desc: "Kõigepealt selgitame välja maa turuväärtuse. See sõltub asukohast, sihtotstarbest ja metsa/põllu omadustest. Õige hind on võti kiireks tehinguks." 
                    },
                    { 
                      icon: UserCheck,
                      title: "2. Ostja leidmine", 
                      desc: "Kasutame oma andmebaasi ja turunduskanaleid, et leida usaldusväärne ostja. Korraldame vajadusel enampakkumise parima hinna saamiseks." 
                    },
                    { 
                      icon: FileCheck,
                      title: "3. Dokumentide kordaajamine", 
                      desc: "Kontrollime üle kinnistusraamatu andmed, piirangud ja hüpoteegid. Valmistame ette kõik vajalikud paberid tehinguks." 
                    },
                    { 
                      icon: Gavel,
                      title: "4. Notariaalne tehing", 
                      desc: "Maa müük toimub alati notaris. Notar kontrollib lepingu seaduslikkust ja raha liigub turvaliselt läbi notari deposiitkonto." 
                    }
                  ].map((step, idx) => (
                ...
                <p className="mb-6 leading-[1.5]">
                  Maa müük ei pea olema keeruline. Meie kogemus tagab sujuva protsessi ja parima tulemuse.
                </p>

                {/* Benefits Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 not-prose mb-12">
                   {[
                    { title: "Täpne hindamine", desc: "Tugineme reaalsetele tehinguandmetele, mitte kuulujuttudele. Saate õiglase turuhinna.", icon: Scale },
                    { title: "Kiire tehing", desc: "Meie ostjate võrgustik võimaldab leida huvilise päevadega, mitte kuudega.", icon: Coins },
                    { title: "Juriidiline tugi", desc: "Meie juristid kontrollivad lepinguid ja kaitsevad Sinu huve notaris.", icon: Gavel },
                    { title: "Isiklik lähenemine", desc: "Oleme Sinu jaoks olemas igal sammul ja vastame kõigile küsimustele.", icon: UserCheck }
                   ].map((item, idx) => (
                ...
                <div className="group mb-12 p-6 rounded-xl bg-[#FFFBF0] border border-[#FDE68A] flex gap-5 not-prose">
                  ...
                  <div className="text-[#92400E] text-sm leading-relaxed">
                    <strong className="block text-[#B45309] mb-2 text-base">Osaline müük?</strong>
                    Kas teadsid, et kinnistut on võimalik ka jagada? Näiteks võid müüa metsamaa ja jätta talukoha koos ümbritseva maaga endale. See protsess nõuab maamõõtmist, kuid on sageli väga mõistlik lahendus. Küsi meilt nõu!
                  </div>
                </div>
                ...
                <div className="mt-20 pt-12 border-t border-gray-100 not-prose">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Card 1 */}
                    <a href="/kinnistu-hindamine/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Telli tasuta eksperthinnang enne müüki.
                      </p>
                    ...
                    <a href="/metsa-muuk-ja-tulumaks/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Kuidas optimeerida maksukohustust seaduslikult?
                      </p>
                      <div className="mt-auto flex items-center text-sm font-bold text-[#347D4E] group-hover:text-[#2d6e43] transition-colors duration-200">
                        Loe lähemalt <ArrowRight size={16} className="ml-2 transform group-hover:translate-x-1 transition-transform duration-200" />
                      </div>
                    ...
                    <a href="/raieoiguse-muuk/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Võib-olla piisab vaid raieõiguse müügist?
                      </p>
                      <div className="mt-auto flex items-center text-sm font-bold text-[#347D4E] group-hover:text-[#2d6e43] transition-colors duration-200">
                        Loe lähemalt <ArrowRight size={16} className="ml-2 transform group-hover:translate-x-1 transition-transform duration-200" />
                      </div>
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="sticky top-24">
                <div className="bg-gradient-to-br from-white to-[#F0F7F4] rounded-2xl p-8 border border-[#347D4E]/10 shadow-[0_20px_40px_-10px_rgba(52,125,78,0.15)] relative overflow-hidden group hover:shadow-[0_30px_60px_-15px_rgba(52,125,78,0.2)] transition-shadow duration-300">
                  ...
                  <h3 className="text-2xl font-bold text-[#1a0f00] mb-2 relative z-10">Müümise plaan?</h3>
                  <p className="text-[#1a0f00]/60 mb-8 relative z-10 leading-relaxed">
                    Küsi meilt tasuta konsultatsiooni. Aitame hinnata Sinu maa väärtust ja leida parima ostja.
                  </p>
