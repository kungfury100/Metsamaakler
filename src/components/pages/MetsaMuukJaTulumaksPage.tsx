...
export const MetsaMuukJaTulumaksPage: React.FC = () => {
  ...
  const faqData = [
    {
      question: "Kui suur on metsa müügi tulumaks?",
      answer: "Eraisiku metsatulu maksustatakse üldjuhul 20% tulumaksuga. Oluline on teada, et maksustatakse kasu (tulu miinus kulud), mitte kogu müügisummat, eeldusel et oskate kulusid õigesti deklareerida."
    },
    {
      question: "Mis on metsa erikonto?",
      answer: "See on spetsiaalne pangakonto, kuhu saab kanda raieõiguse või metsamaterjali müügist saadud tulu. See võimaldab tulumaksu tasumist edasi lükata kuni 3 aastat, et kasutada raha uuteks metsamajanduslikeks investeeringuteks."
    },
    {
      question: "Kas kinnistu müük on maksuvaba?",
      answer: "Üldjuhul mitte. Kinnistu müügil maksustatakse kasu (müügihind miinus soetamismaksumus ja müügikulud). Maksuvabastus kehtib vaid erandjuhtudel, näiteks omandireformi käigus tagastatud maa esmasel võõrandamisel."
    }
  ];
  ...
  const schema = {
    ...
    '@graph': [
      {
        '@type': 'Article',
        'headline': 'Metsa müük ja tulumaks',
        'description': 'Kuidas maksustatakse metsa müüki? Info tulumaksu, metsa erikonto ja kulude mahaarvamise kohta.',
        'author': {
          '@type': 'Organization',
          'name': 'Metsamaakler'
        },
      ...
      },
      {
        ...
        'itemListElement': [
          ...
          },
          {
            '@type': 'ListItem',
            'position': 3,
            'name': 'Metsa müük ja tulumaks',
            'item': 'https://metsamaakler.ee/metsa-muuk-ja-tulumaks/'
          }
        ]
      },
      {
  ...
  useSeo({
    title: "Metsa müük ja tulumaks – Erikonto ja maksusoodustused | Metsamaakler",
    description: "Metsa müügi maksustamine, tulumaks ja deklareerimine. Loe, kuidas kasutada metsa erikontot ja arvata tulust maha metsamajandamise kulusid.",
    canonical: "https://metsamaakler.ee/metsa-muuk-ja-tulumaks/",
    ogImage: HERO_IMAGE,
    schema: schema
  });
  ...
  return (
    <div className="min-h-screen relative bg-white font-inter selection:bg-[#347D4E] selection:text-white">
      ...
      <main className="relative z-10">
        <ServiceHero 
          image={HERO_IMAGE}
          title="Metsa müük ja tulumaks"
          subtitle="Metsa müügist saadud tulu on maksustatav, kuid tark omanik oskab kasutada seadusega lubatud võimalusi maksukoormuse optimeerimiseks ja hajutamiseks."
          onCtaClick={handleCtaClick}
          breadcrumbs={[
            { label: "Avaleht", href: "/" },
            { label: "Teenused", href: "/" },
            { label: "Metsa müük ja tulumaks", href: "/metsa-muuk-ja-tulumaks/" }
          ]}
        />
            ...
            <div className="lg:col-span-8">
              <article className="prose prose-lg max-w-none text-[#1a0f00]/70">
                ...
                <h2 className="text-[32px] md:text-[40px] font-bold text-[#1a0f00] mb-8 leading-[1.1] tracking-tight">
                  Kuidas metsatulu maksustatakse?
                </h2>
                
                <p className="mb-6 text-lg md:text-xl leading-snug font-normal text-[#1a0f00]/80">
                  Metsa müügist saadav tulu kuulub deklareerimisele ja maksustamisele tulumaksuga (määr 20%). Siiski on oluline vahet teha, kas müüte <strong>raieõigust/metsamaterjali</strong> või <strong>metsakinnistut</strong>, sest maksureeglid on erinevad.
                </p>

                {/* Comparison Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 not-prose mb-12">
                   <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 transition-all duration-300 group flex flex-col h-full">
                      <div className="w-14 h-14 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 mb-6 group-hover:scale-110 transition-transform duration-300">
                        <FileText size={28} strokeWidth={1.5} />
                      </div>
                      <h3 className="text-xl font-bold text-[#1a0f00] mb-3 group-hover:text-[#347D4E] transition-colors duration-200">
                        Raieõiguse ja materjali müük
                      </h3>
                      <p className="text-[#1a0f00]/70 mb-6 leading-relaxed flex-grow">
                        Metsaomanikul on suur eelis: saadud tulust on lubatud maha arvata metsa majandamisega seotud dokumentaalselt tõendatud kulud (nt istutamine, hooldus, metsakava tegemine).
                      </p>
                      <div className="pt-6 border-t border-gray-50">
                        <span className="inline-flex items-center text-sm font-bold text-[#347D4E] bg-[#347D4E]/5 px-3 py-1.5 rounded-lg">
                          Maksustatakse puhastulu
                        </span>
                      </div>
                   </div>

                   <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 transition-all duration-300 group flex flex-col h-full">
                      <div className="w-14 h-14 rounded-xl bg-amber-50 flex items-center justify-center text-amber-600 mb-6 group-hover:scale-110 transition-transform duration-300">
                      ...
                      <p className="text-[#1a0f00]/70 mb-6 leading-relaxed flex-grow">
                        Kinnistu müügil maksustatakse kasu: müügihind miinus soetamismaksumus (ostuhind + ostuga seotud kulud). Siin ei saa maha arvata jooksvaid majandamiskulusid.
                      </p>
                      <div className="pt-6 border-t border-gray-50">
                        <span className="inline-flex items-center text-sm font-bold text-[#347D4E] bg-[#347D4E]/5 px-3 py-1.5 rounded-lg">
                          Maksustatakse kasu
                ...
                <h2 className="text-[28px] md:text-[32px] font-bold text-[#1a0f00] mt-16 mb-8 leading-tight">
                  Võimalus makse edasi lükata: Metsatulu erikonto
                </h2>
                <p className="mb-6 leading-[1.5]">
                  Füüsilisest isikust metsaomanikul on õigus avada pangas eraldi arvelduskonto, mida deklareeritakse kui "metsatulu erikontot". See annab paindlikkuse maksude planeerimisel.
                </p>
                ...
                <div className="space-y-6 not-prose mb-12">
                  {[
                    { 
                      icon: CalendarClock,
                      title: "3 aastat maksuvaba", 
                      desc: "Erikontole kantud tulu pealt ei pea kohe tulumaksu maksma. Maksukohustus tekib alles siis, kui võtate raha kontolt välja või kui möödub 3 aastat." 
                    },
                    { 
                      icon: TrendingUp,
                      title: "Investeeri tulumaksuvabalt", 
                      desc: "Kui kasutate erikontol olevat raha metsa majandamiseks (uue metsa ost, istutamine, tehnika), siis seda raha ei maksustata." 
                    },
                    { 
                      icon: Calculator,
                      title: "Kulude deklareerimine", 
                      desc: "Tuludeklaratsioonis (Vorm E) tuleb näidata erikontole laekunud summad ja sealt tehtud kulutused. Hoidke kõik arved alles!" 
                    }
                  ].map((step, idx) => (
                ...
                <div className="group mb-12 p-6 rounded-xl bg-[#FFFBF0] border border-[#FDE68A] flex gap-5 not-prose">
                  ...
                  <div className="text-[#92400E] text-sm leading-relaxed">
                    <strong className="block text-[#B45309] mb-2 text-base">Oluline nüanss</strong>
                    Metsatulu erikontot saavad kasutada ainult füüsilised isikud ja FIE-d raieõiguse ning metsamaterjali müügi puhul. Kinnistu müügitulu erikontole kanda ei saa.
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <a href="/raieoiguse-muuk/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Kuidas müüa raieõigust parima hinnaga?
                      </p>
                    ...
                    <a href="/metsa-muugi-notaritasud/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Kes maksab tehingu vormistamise eest?
                      </p>
                      <div className="mt-auto flex items-center text-sm font-bold text-[#347D4E] group-hover:text-[#2d6e43] transition-colors duration-200">
                        Loe lähemalt <ArrowRight size={16} className="ml-2 transform group-hover:translate-x-1 transition-transform duration-200" />
                      </div>
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="sticky top-24">
                <div className="bg-gradient-to-br from-white to-[#F0F7F4] rounded-2xl p-8 border border-[#347D4E]/10 shadow-[0_20px_40px_-10px_rgba(52,125,78,0.15)] relative overflow-hidden group hover:shadow-[0_30px_60px_-15px_rgba(52,125,78,0.2)] transition-shadow duration-300">
                  ...
                  <h3 className="text-2xl font-bold text-[#1a0f00] mb-2 relative z-10">Maksud tekitavad küsimusi?</h3>
                  <p className="text-[#1a0f00]/60 mb-8 relative z-10 leading-relaxed">
                    Aitame mõista müügitehingu maksunüansse ja planeerida tulusid targalt. Küsi tasuta nõu.
                  </p>
