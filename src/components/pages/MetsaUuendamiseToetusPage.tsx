...
export const MetsaUuendamiseToetusPage: React.FC = () => {
  ...
  const faqData = [
    {
      question: "Kes saavad toetust taotleda?",
      answer: "Toetust saavad taotleda erametsaomanikud. Kõige mugavam on seda teha läbi kohaliku metsaühistu, kuna ühistu liikmetele kehtivad sageli soodsamad tingimused ja kõrgemad toetusmäärad."
    },
    {
      question: "Millal toetust makstakse?",
      answer: "Toetust makstakse tavaliselt välja pärast tööde teostamist ja nõuetekohast deklareerimist. Menetlusprotsess võib võtta aega mitu kuud pärast taotlusvooru sulgemist."
    },
    {
      question: "Kas maapinna ettevalmistamine on toetatav?",
      answer: "Jah, maapinna ettevalmistamine (näiteks ketasadraga) on üks toetatavatest tegevustest, kuna see on eelduseks edukaks istutamiseks."
    }
  ];
  ...
  const schema = {
    ...
    '@graph': [
      {
        '@type': 'Article',
        'headline': 'Metsa uuendamise toetus',
        'description': 'Kuidas taotleda metsa uuendamise toetust? Info toetatavate tegevuste, tähtaegade ja tingimuste kohta.',
        'author': {
          '@type': 'Organization',
          'name': 'Metsamaakler'
        },
      ...
      },
      {
        ...
        'itemListElement': [
          ...
          },
          {
            ...
            'item': 'https://metsamaakler.ee/metsa-uuendamise-toetus/'
          }
        ]
      },
      {
  ...
  useSeo({
    title: "Metsa uuendamise toetus – Tingimused ja taotlemine | Metsamaakler",
    description: "Planeerid uue metsa istutamist? Uuri, milliseid kulusid riik kompenseerib. Info taimede soetamise, istutamise ja maapinna ettevalmistamise toetuste kohta.",
    canonical: "https://metsamaakler.ee/metsa-uuendamise-toetus/",
    ogImage: HERO_IMAGE,
    schema: schema
  });
  ...
  return (
    <div className="min-h-screen relative bg-white font-inter selection:bg-[#347D4E] selection:text-white">
      ...
      <main className="relative z-10">
        <ServiceHero 
          image={HERO_IMAGE}
          title="Metsa uuendamise toetus"
          subtitle="Uue metsa rajamine on investeering tulevikku. Riik toetab erametsaomanikke selle kuluka töö tegemisel, kattes osa taimede ja tööjõu kuludest."
          onCtaClick={handleCtaClick}
          breadcrumbs={[
            { label: "Avaleht", href: "/" },
            { label: "Teenused", href: "/" },
            { label: "Metsa uuendamise toetus", href: "/metsa-uuendamise-toetus/" }
          ]}
        />
            ...
            <div className="lg:col-span-8">
              <article className="prose prose-lg max-w-none text-[#1a0f00]/70">
                ...
                <h2 className="text-[32px] md:text-[40px] font-bold text-[#1a0f00] mb-8 leading-[1.1] tracking-tight">
                  Miks taotleda metsa uuendamise toetust?
                </h2>
                
                <p className="mb-6 text-lg md:text-xl leading-snug font-normal text-[#1a0f00]/80">
                  Metsa uuendamine (istutamine, külvamine) on metsaomaniku üks suurimaid väljaminekuid. Kvaliteetsed metsataimed ja maapinna ettevalmistamine maksavad arvestatava summa.
                </p>

                <p className="mb-10 leading-[1.5]">
                  <strong>Metsa uuendamise toetus</strong> on loodud selleks, et motiveerida omanikke pärast raiet kiiresti uut ja kvaliteetset metsa rajama. Toetus on siseriiklik ja seda jagab SA Erametsakeskus (KIK).
                </p>

                {/* Supported Activities Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 not-prose mb-12">
                   {[
                    { title: "Taimede soetamine", desc: "Hüvitatakse osa sertifitseeritud metsataimede (potitaimed või avajuursed) ostuhinnast. Vajalik taimepass.", icon: Sprout },
                    { title: "Maapinna ettevalmistus", desc: "Enne istutamist tuleb maapind ette valmistada (ketasadraga vaod või lapid). Ka see kulu on hüvitatav.", icon: Shovel },
                    { title: "Istutamine ja külvamine", desc: "Toetust saab küsida istutustööde eest. Isegi ise tehes on võimalik taotleda toetust töömahule.", icon: Coins },
                    { title: "Uuenduse hooldamine", desc: "Esimestel aastatel vajavad noored taimed hoolt (niitmine, võsa tõrjumine), et nad lämbuma ei hakkaks.", icon: FileCheck }
                   ].map((item, idx) => (
                ...
                <p className="mb-6 leading-[1.5]">
                  Protsess on loogiline, kuid nõuab täpsust. Tavaliselt toimub kaks taotlusvooru aastas (kevadine ja sügisene).
                </p>
                ...
                <div className="space-y-6 not-prose mb-12">
                  {[
                    { 
                      icon: CheckCircle2,
                      title: "1. Tööde teostamine", 
                      desc: "Erinevalt mõnest muust toetusest, tuleb metsa uuendamise puhul tööd (taimede ost, istutus) üldjuhul enne ära teha ja arved tasuda." 
                    },
                    { 
                      icon: ClipboardList,
                      title: "2. Taotluse esitamine", 
                      desc: "Kui voor avaneb (jälgi eramets.ee infot), esita taotlus koos kuludokumentidega (arved, maksekorraldused, taimepassid)." 
                    },
                    { 
                      icon: Coins,
                      title: "3. Kontroll ja väljamakse", 
                      desc: "Erametsakeskus kontrollib dokumente ja vajadusel teeb paikvaatluse. Kui kõik on korras, laekub toetus kontole." 
                    }
                  ].map((step, idx) => (
                ...
                <div className="group mb-12 p-6 rounded-xl bg-[#FFFBF0] border border-[#FDE68A] flex gap-5 not-prose">
                  ...
                  <div className="text-[#92400E] text-sm leading-relaxed">
                    <strong className="block text-[#B45309] mb-2 text-base">Oluline tähtaegadest</strong>
                    Toetuse taotlemise tähtajad on ranged. Hilinenud taotlusi vastu ei võeta. Soovitame alati hakata dokumente ette valmistama varakult või kasutada metsaühistu abi.
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <a href="/metsa-istutamine/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Loe lähemalt istutamise protsessist.
                      </p>
                    ...
                    {/* Card 2 */}
                    <a href="/metsa-inventeerimise-toetus/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      <div className="mb-6 text-[#347D4E] group-hover:scale-105 transition-transform duration-200">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Toetus metsamajandamiskava tellimiseks.
                      </p>
                      <div className="mt-auto flex items-center text-sm font-bold text-[#347D4E] group-hover:text-[#2d6e43] transition-colors duration-200">
                        Loe lähemalt <ArrowRight size={16} className="ml-2 transform group-hover:translate-x-1 transition-transform duration-200" />
                      </div>
                    ...
                    <a href="/metsa-muuk-ja-tulumaks/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Kuidas planeerida makse metsa majandamisel?
                      </p>
                      <div className="mt-auto flex items-center text-sm font-bold text-[#347D4E] group-hover:text-[#2d6e43] transition-colors duration-200">
                        Loe lähemalt <ArrowRight size={16} className="ml-2 transform group-hover:translate-x-1 transition-transform duration-200" />
                      </div>
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="sticky top-24">
                <div className="bg-gradient-to-br from-white to-[#F0F7F4] rounded-2xl p-8 border border-[#347D4E]/10 shadow-[0_20px_40px_-10px_rgba(52,125,78,0.15)] relative overflow-hidden group hover:shadow-[0_30px_60px_-15px_rgba(52,125,78,0.2)] transition-shadow duration-300">
                  ...
                  <h3 className="text-2xl font-bold text-[#1a0f00] mb-2 relative z-10">Metsamaakler aitab Sind</h3>
                  <p className="text-[#1a0f00]/60 mb-8 relative z-10 leading-relaxed">
                    Teostame metsa uuendamistöid "võtmed kätte" ja aitame vormistada toetusdokumendid.
                  </p>
