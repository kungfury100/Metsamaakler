...
export const MetsaIstutaminePage: React.FC = () => {
  ...
  const faqData = [
    {
      question: "Millal on parim aeg metsa istutada?",
      answer: "Parim aeg istutamiseks on kevad (aprill-mai), kohe pärast maapinna sulamist ja enne pungade puhkemist. Sügisene istutus (september-oktoober) sobib hästi potitaimedele, eriti kuusele, kuid tuleb jälgida, et taimed jõuaksid enne külmasid juurduda."
    },
    {
      question: "Mitu taime tuleks hektarile istutada?",
      answer: "See sõltub puuliigist ja kasvukohast. Harilikult istutatakse hektarile: mändi 3000-3500 tk, kuuske 1800-2200 tk ja kaske 2000-2500 tk. Hõredam istutus suurendab ohtu, et puud kasvavad liiga okslikuks."
    },
    {
      question: "Kas maapinna ettevalmistus on vajalik?",
      answer: "Jah, see on kriitilise tähtsusega. Ettevalmistatud maapind vähendab konkurentsi rohttaimedega, parandab niiskusrežiimi ja tõstab oluliselt taimede ellujäämisprotsenti. Ilma selleta on oht, et noor mets lämbub heina sisse."
    },
    {
      question: "Mis vahe on potitaimel ja avajuurse taimel?",
      answer: "Potitaim (suletud juurekavaga) on kasvatatud turba-mulla segus. Tal on parem ellujäämus ja pikem istutusperiood. Avajuurne taim on odavam, kuid tundlikum kuivamise suhtes ja sobib istutamiseks vaid lühikesel perioodil kevadel või sügisel."
    }
  ];
  ...
  const schema = {
    ...
    '@graph': [
      {
        '@type': 'Service',
        'name': 'Metsa istutamine',
        'description': 'Professionaalne metsa istutamine ja maapinna ettevalmistus. Kvaliteetsed istikud ja garantii töödele.',
        'provider': {
          '@type': 'LocalBusiness',
          'name': 'Metsamaakler',
      ...
      },
      {
        ...
        'itemListElement': [
          ...
          },
          {
            ...
            'position': 3,
            'name': 'Metsa istutamine',
            'item': 'https://metsamaakler.ee/metsa-istutamine/'
          }
        ]
      },
      {
  ...
  useSeo({
    title: "Metsa istutamine – Tugeva metsa vundament | Metsamaakler",
    description: "Kvaliteetne metsa istutamine ja maapinna ettevalmistus üle Eesti. Vali õiged taimed ja professionaalne teostus. Küsi pakkumist!",
    canonical: "https://metsamaakler.ee/metsa-istutamine/",
    ogImage: HERO_IMAGE,
    schema: schema
  });
    ...
    <div className="min-h-screen relative bg-white font-inter selection:bg-[#347D4E] selection:text-white">
      ...
      <main className="relative z-10">
        <ServiceHero 
          ...
          subtitle="Uue metsa rajamine on vastutusrikas töö. Rajame elujõulise metsa, mis pakub väärtust ka järeltulevatele põlvedele."
            ...
            <div className="lg:col-span-8">
              <article className="prose prose-lg max-w-none text-[#1a0f00]/70">
                ...
                <h2 className="text-[32px] md:text-[40px] font-bold text-[#1a0f00] mb-8 leading-[1.1] tracking-tight">
                  Metsa istutamine – alus uue metsa tekkele
                </h2>
                
                <p className="mb-6 text-lg md:text-xl leading-snug font-normal text-[#1a0f00]/80">
                  Metsa uuendamine ei ole pelgalt seadusest tulenev kohustus, vaid teadlik investeering tulevikku. <strong>Metsa istutamine</strong> on kõige kiirem ja kindlam viis uue metsapõlve rajamiseks pärast lageraiet.
                </p>

                <p className="mb-10 leading-[1.5]">
                  Kuigi mets suudab uueneda ka looduslikult, tagab istutamine soovitud puuliigi, kiirema algarengu ja ühtlasema puistu. See tähendab, et mets saavutab küpsuse 10–20 aastat varem kui loodusliku uuenduse korral ning puidu kvaliteet on oluliselt kõrgem.
                </p>
                  ...
                  <div className="relative z-10 flex items-start gap-6">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="text-xl font-bold text-[#1a0f00] m-0 tracking-tight">Investeering tulevikku</h3>
                      ...
                      <p className="text-[#1a0f00]/70 m-0 leading-normal text-base">
                        Kasutame vaid sertifitseeritud ja Eesti kliimasse sobivaid taimi. See tagab, et uus mets on vastupidav haigustele ja kliimamuutustele. Lisaks anname oma tööle garantii – kui taimed peaksid hukkuma meie vea tõttu, asendame need tasuta.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <h2 className="text-[28px] md:text-[32px] font-bold text-[#1a0f00] mt-16 mb-8 leading-tight">
                  Kuidas valida õige puuliik ja taimetüüp?
                </h2>
                <p className="mb-6 leading-[1.5]">
                  Edukas metsa istutamine algab planeerimisest. Vale puuliigi valik ebasobivale kasvukohale on kulukas viga, mida on hiljem raske parandada.
                </p>

                {/* Tree Types Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 not-prose mb-12">
                   {[
                    { title: "Harilik mänd", desc: "Sobib hästi liivastele ja kuivadele muldadele (nõmmemetsad), aga ka rabadesse. Väga valgusnõudlik.", icon: Sun },
                    { title: "Harilik kuusk", desc: "Eelistab viljakaid ja parasniiskeid muldi (laane- ja salumetsad). Talub varju paremini kui mänd.", icon: Trees },
                    { title: "Arukask", desc: "Kiirekasvuline, sobib hästi endistele põllumaadele ja viljakatele metsamaadele. Tundlik liigniiskuse suhtes.", icon: CloudRain }
                   ].map((item, idx) => (
                ...
                <h2 className="text-[28px] md:text-[32px] font-bold text-[#1a0f00] mt-16 mb-8 leading-tight">
                  Istutustööde etapid ja ajastus
                </h2>
                <p className="mb-6 leading-[1.5]">
                  Metsa istutamine nõuab täpset ajastust ja logistikat. Hilinemine võib tähendada, et taimed jäävad kuiva kätte või ei jõua enne talve piisavalt puituda.
                </p>
                ...
                <div className="space-y-6 not-prose mb-12">
                  {[
                    { 
                      icon: Shovel,
                      title: "1. Maapinna ettevalmistus", 
                      desc: "Kriitilise tähtsusega etapp. Ettevalmistatud pinnas (nt mätas või vagu) parandab niiskusrežiimi ja vähendab konkurentsi heinaga." 
                    },
                    { 
                      icon: Calendar,
                      title: "2. Kevadine istutus (Aprill-Mai)", 
                      desc: "Kõige populaarsem ja kindlam aeg. Muld on talvest niiske. Sobib kõigile taimetüüpidele (nii avajuursed kui potitaimed)." 
                    },
                    { 
                      icon: Sun,
                      title: "3. Sügisene istutus (Sept-Okt)", 
                      desc: "Sobib hästi potitaimedele (eriti kuusk). Mändi sügisel istutada ei soovitata külmakergituse ohu tõttu." 
                    },
                    { 
                      icon: CheckCircle2,
                      title: "4. Hooldus", 
                      desc: "Noor mets vajab hoolt. Esimestel suvedel on vaja niita heina (kultuuride hooldamine), et see taimi ei lämmataks." 
                    }
                  ].map((step, idx) => (
                ...
                <div className="group mb-12 p-6 rounded-xl bg-[#FFFBF0] border border-[#FDE68A] flex gap-5 not-prose">
                  ...
                  <div className="text-[#92400E] text-sm leading-relaxed">
                    <strong className="block text-[#B45309] mb-2 text-base">Toetused on abiks</strong>
                    Riik toetab erametsaomanikke metsa uuendamisel. Erametsakeskuse kaudu saab taotleda toetust nii taimede soetamiseks, maapinna ettevalmistamiseks kui ka hilisemaks hoolduseks. Aitame Sind taotluste vormistamisel.
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <a href="/metsa-uuendamise-toetus/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Info riiklike toetuste kohta metsaistutuseks.
                      </p>
                    ...
                    <a href="/metsamajandamiskava/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Kava aitab planeerida istutust ja hooldust.
                      </p>
                      <div className="mt-auto flex items-center text-sm font-bold text-[#347D4E] group-hover:text-[#2d6e43] transition-colors duration-200">
                        Loe lähemalt <ArrowRight size={16} className="ml-2 transform group-hover:translate-x-1 transition-transform duration-200" />
                      </div>
                    ...
                    <a href="/valgustusraie/" className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#347D4E]/30 hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 ease-out flex flex-col items-start h-full">
                      ...
                      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Noorendike hooldus on järgmine samm.
                      </p>
                      <div className="mt-auto flex items-center text-sm font-bold text-[#347D4E] group-hover:text-[#2d6e43] transition-colors duration-200">
                        Loe lähemalt <ArrowRight size={16} className="ml-2 transform group-hover:translate-x-1 transition-transform duration-200" />
                      </div>
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="sticky top-24">
                <div className="bg-gradient-to-br from-white to-[#F0F7F4] rounded-2xl p-8 border border-[#347D4E]/10 shadow-[0_20px_40px_-10px_rgba(52,125,78,0.15)] relative overflow-hidden group hover:shadow-[0_30px_60px_-15px_rgba(52,125,78,0.2)] transition-shadow duration-300">
                  ...
                  <h3 className="text-2xl font-bold text-[#1a0f00] mb-2 relative z-10">Plaanid metsa istutada?</h3>
                  <p className="text-[#1a0f00]/60 mb-8 relative z-10 leading-relaxed">
                    Küsi pakkumist taimedele ja istutustöödele. Aitame ka toetuste taotlemisel.
                  </p>
